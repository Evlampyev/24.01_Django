"""
Django settings for sem_1_project project.
...
SECRET_KEY = 'django-insecure-u(fh^0*dj$m#)(s#%j%822sv9!vs4yv&2kv08wh%bb2o%67=x+'
...
ROOT_URLCONF = 'sem_1_project.urls'
...
WSGI_APPLICATION = 'sem_1_project.wsgi.application'
...
LOGGING = {
    ...
    'loggers'                : {
        ...
        'secondapp': {  # для моего приложения в проекте
            'handlers' : ['console', 'file'],
            'level'    : 'DEBUG',
            'propagate': True,
